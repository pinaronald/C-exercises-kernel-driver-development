 ...
 *
 *    Description:  Adapt one of the previous drivers to allocate the device major 
 *    number dynamically.
 *
 *     Write loading and unloading scripts that ascertain the major number assigned
 *     and make and remove the node as required
 *
